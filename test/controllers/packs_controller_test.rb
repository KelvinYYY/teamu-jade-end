...
class PacksControllerTest < ActionController::TestCase
  ...
  test "should create pack" do
    assert_difference('Pack.count') do
      post :create, pack: { city: @pack.city, id: @pack.id, population: @pack.population, state: @pack.state }
    end
  ...
  test "should update pack" do
    patch :update, id: @pack, pack: { city: @pack.city, id: @pack.id, population: @pack.population, state: @pack.state }
    assert_redirected_to pack_path(assigns(:pack))
  end
